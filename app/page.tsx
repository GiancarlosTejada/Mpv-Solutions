export default function Home() {
  // Lista de marcas extraídas de tu imagen
  const marcas = [
    "SCI", "CROUSE-HINDS", "EATON", "CANTEX", "SOUTHWIRE", 
    "PENN CONDUIT", "SYP", "THOMPSON", "FLOWCOM", "CPLAST", 
    "FLORIDA STRUT", "SEPCO", "PRODUIT", "COPEFLEX", "COPLEFLEX", "IPEX"
  ];

  // Datos de la sección de Industrias con tus nuevos nombres de archivo
  const industrias = [
    {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6 tracking-tight">
              Equipa tus Proyectos con <span className="text-yellow-500">MPV Solutions</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#productos" className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-4 rounded-lg flex items-center gap-2 transition">
                Explorar Catálogo
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
              </a>
              <a href="#contacto" className="bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 text-white font-semibold px-8 py-4 rounded-lg transition">
                Contactar Ventas
              </a>
            </div>
          </div>

          {/* Imagen Derecha (Sección Principal) */}
          <div className="relative flex justify-center items-center h-[450px]">
             {/* Caja Amarilla Decorativa */}
             <div className="absolute z-10 right-0 top-4 w-64 h-64 bg-yellow-500 rounded-lg shadow-2xl transform rotate-12 flex items-center justify-center p-6 text-neutral-900 border-4 border-yellow-400">
                <div className="font-black text-4xl transform -rotate-12">MPV<br/>CERTIFIED</div>
             </div>
             
             {/* CUADRO INDUSTRIAL GRADE */}
             <div className="group absolute z-20 left-4 bottom-4 w-80 h-96 bg-neutral-800 rounded-lg shadow-2xl transform -rotate-6 border border-neutral-700 p-6 flex flex-col justify-between">
                
                {/* Título superior */}
                <div className="text-white font-bold text-xl drop-shadow-md z-10">Industrial Grade</div>
                
                {/* CUADRO INTERIOR: Contenedor con tu imagen de cable */}
                <div className="relative w-full h-2/3 bg-neutral-900 rounded-md overflow-hidden border border-neutral-700/50 shadow-inner">
                  <img 
                    src="/cable.webp" 
                    alt="Cables Industriales MPV" 
      ...
      <section className="border-y border-neutral-800 bg-neutral-950/40 py-10 overflow-hidden w-full">
        <div className="w-full">
          <p className="text-neutral-500 text-center text-xs font-semibold tracking-widest uppercase mb-6">
            Distribuidor Autorizado de Marcas Líderes
          </p>
          <div className="relative w-full overflow-hidden flex">
            <div className="carrusel-activo flex items-center gap-16 pr-16">
              {[...marcas, ...marcas, ...marcas].map((marca, index) => (
                <span 
                  key={index} 
                  className="text-xl md:text-2xl font-black text-neutral-400 hover:text-white tracking-wide transition-colors uppercase whitespace-nowrap cursor-default"
                >
                  {marca}
                </span>
              ))}
      ...
      <section id="industrias" className="py-32 bg-neutral-900/30">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            <p className="text-3xl md:text-5xl font-black text-white tracking-tight mb-6">
          ...
          {/* Cuadrícula de Tarjetas con Imagen */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {industrias.map((item, idx) => (
              <div 
                key={idx} 
                className="group relative bg-neutral-950 border border-neutral-800 rounded-xl h-[420px] p-8 transition-all duration-300 hover:border-orange-500/50 hover:-translate-y-1 flex flex-col justify-end overflow-hidden"
              >
      ...
      <section className="py-32">
        <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-1">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Soluciones a las Exigencias Industriales
            </h2>
            <p className="text-neutral-400 leading-relaxed text-lg">
              En MPV Solutions, enfrentamos los retos únicos del sector energético e industrial.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                Benefíciate de nuestros equipos comprometidos que aseguran que tu éxito sea personal.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                Encuentra soluciones certificadas y accesibles.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                Integra con facilidad utilizando nuestras exhaustivas guías y fichas técnicas.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                Garantizamos entregas oportunas y un suministro confiable directamente a tus instalaciones.
              </p>
            </div>
          </div>
        </div>
